...
type DownloadArticleReq struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// @inject_tag: uri:"article_id"
	ArticleId     int32 `protobuf:"varint,1,opt,name=article_id,json=articleId,proto3" json:"article_id,omitempty" uri:"article_id"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DownloadArticleReq) Reset() {
	*x = DownloadArticleReq{}
	mi := &file_product_app_v1_v1_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DownloadArticleReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DownloadArticleReq) ProtoMessage() {}

func (x *DownloadArticleReq) ProtoReflect() protoreflect.Message {
	mi := &file_product_app_v1_v1_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DownloadArticleReq.ProtoReflect.Descriptor instead.
func (*DownloadArticleReq) Descriptor() ([]byte, []int) {
	return file_product_app_v1_v1_proto_rawDescGZIP(), []int{3}
}

func (x *DownloadArticleReq) GetArticleId() int32 {
	if x != nil {
		return x.ArticleId
	}
	return 0
...
func (x *GetArticleXMLReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetArticleXMLReq) ProtoMessage() {}

func (x *GetArticleXMLReq) ProtoReflect() protoreflect.Message {
	mi := &file_product_app_v1_v1_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetArticleXMLReq.ProtoReflect.Descriptor instead.
func (*GetArticleXMLReq) Descriptor() ([]byte, []int) {
	return file_product_app_v1_v1_proto_rawDescGZIP(), []int{4}
}

func (x *GetArticleXMLReq) GetArticleId() int32 {
	if x != nil {
		return x.ArticleId
	}
	return 0
...
const file_product_app_v1_v1_proto_rawDesc = "" +
	"\n" +
	"\x17product/app/v1/v1.proto\x12\x0eproduct.app.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"t\n" +
	...
	"\tauthor_id\x18\x03 \x01(\x05R\bauthorId\"3\n" +
	"\x12DownloadArticleReq\x12\x1d\n" +
	"\n" +
	"article_id\x18\x01 \x01(\x05R\tarticleId\"1\n" +
	"\x10GetArticleXMLReq\x12\x1d\n" +
	"\n" +
	"article_id\x18\x01 \x01(\x05R\tarticleId2\xf0\x03\n" +
	...
	"\rCreateArticle\x12\x17.product.app.v1.Article\x1a\x17.product.app.v1.Article\"'\x82\xd3\xe4\x93\x02!\"\x1f/v1/author/{author_id}/articles\x12y\n" +
	"\x0fDownloadArticle\x12\".product.app.v1.DownloadArticleReq\x1a\x16.google.protobuf.Empty\"*\x82\xd3\xe4\x93\x02$\x12\"/v1/articles/{article_id}/download\x12p\n" +
	"\rGetArticleXML\x12 .product.app.v1.GetArticleXMLReq\x1a\x16.google.protobuf.Empty\"%\x82\xd3\xe4\x93\x02\x1f\x12\x1d/v1/articles/{article_id}/xmlBCZAgithub.com/mohuishou/protoc-gen-go-gin/example/api/product/app/v1b\x06proto3"
...
var file_product_app_v1_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_product_app_v1_v1_proto_goTypes = []any{
	...
	(*DownloadArticleReq)(nil), // 3: product.app.v1.DownloadArticleReq
	(*GetArticleXMLReq)(nil),   // 4: product.app.v1.GetArticleXMLReq
...
var file_product_app_v1_v1_proto_depIdxs = []int32{
	...
	3, // 3: product.app.v1.BlogService.DownloadArticle:input_type -> product.app.v1.DownloadArticleReq
	4, // 4: product.app.v1.BlogService.GetArticleXML:input_type -> product.app.v1.GetArticleXMLReq
	1, // 5: product.app.v1.BlogService.GetArticles:output_type -> product.app.v1.GetArticlesResp
	2, // 6: product.app.v1.BlogService.CreateArticle:output_type -> product.app.v1.Article
	5, // 7: product.app.v1.BlogService.DownloadArticle:output_type -> google.protobuf.Empty
	5, // 8: product.app.v1.BlogService.GetArticleXML:output_type -> google.protobuf.Empty
